...
public class LoggerMarshaller implements JsonSerializer<Object>, JsonDeserializer<Object> {
    ...
    public Object deserialize(JsonElement jsonElement, Type type,
        ...
        if(classMetaKey != null) {
            ...
            className = Log4jLogger.class.getCanonicalName(); // This is a reasonable default for backwards-compatibility.
        }
